            ...
            for j in range(len(docstrings[i])):
                ...
                if is_see_also_line and entries_str:
                    ...
                    for k in range(len(entries)):
                        ...
                        if match2 := class_re.search(entries[k]):
                            m1 = match2[1]
                            m2 = match2[2]
                            if (
                                self.env.config.matlab_keep_package_prefix
    ...
    def filter_members(self, members, want_all):
        ...
        def member_is_friend_of(member, friends):
            ...
            if attrs:
                ...
                if not isinstance(access, list):
                    access = [access]
                return any(has_access in friends for has_access in access)
            else:
                return False
        ...
        for membername, member in members:
            ...
            if want_all and member_is_special():
                ...
                if self.options.protected_members is ALL or (
                ...
                if self.options.hidden_members is ALL or (
                ...
                if self.options.friend_members is ALL or (
...
class MatClassDocumenter(MatModuleLevelDocumenter):
    ...
    def add_content(self, more_content):
        if self.doc_as_attr:
            if classname := safe_getattr(self.object, "__name__", None):
    ...
    def document_member_section(self, heading, new_excludes, all_members):
        ...
        indent = self.indent
        exclude_members = self.options.exclude_members or []
